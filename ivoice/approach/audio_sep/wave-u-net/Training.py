...
def train(model_config, experiment_id, load_model=None):
    ...
    print("当前savepath是:"+str(save_path))
...
def optimise(model_config, experiment_id):
    epoch = 0
    best_loss = 10000
    #这边需要对model——path进行修改，以达到可以继续训练的目的
    model_path = "checkpoints/641229/641229-120000"
    # model_path = None
    ...
    while worse_epochs < model_config["worse_epochs"]:  # Early stopping on validation set after a few epochs
        ...
        if curr_loss < best_loss:
            ...
            print("In this epoch worse_epochs " + str(worse_epochs))
