...
'''
Ingerdient提供一种组合机制，将相关的模型的配置放入了config_ingredient中，它的名称是cfg
'''
...
def cfg():
    # Base configuration
    model_config = {"musdb_path" : "E:\音乐分离系统相关\数据集", # SET MUSDB PATH HERE, AND SET CCMIXTER PATH IN CCMixter.xml
                    ...
                    "batch_size" : 32, # Batch size原来是16
                    "init_sup_sep_lr" : 1e-5, # Supervised separator learning rate原来是1e-4
