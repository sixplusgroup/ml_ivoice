...
def enhance_speech_with_DeepXi(input_dir, output_dir, version="mhanet-1.1c", gain="mmse-lsa"):
    """
    ...
    """
    VIRTUAL_ENV = os.path.abspath("../../external/DeepXi/venv")
    os.environ['PATH'] = VIRTUAL_ENV + "/bin:" + os.environ['PATH']
    os.chdir('../../external/DeepXi')
