...
if __name__ == '__main__':
    ...
    parser.add_argument('--mix_file_path', type=str, default='../../../data/input/')
    parser.add_argument('--esti_file_path', type=str, default='../../../data/output/DB-AIAT')
